...
import 'package:clean2/moveis/presentation/screen/dummy.dart';
...
class MovieDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(create: (BuildContext context) =>sl<MovieDetailesBloc>()
      ..add(GetMovieDetailesEvent(id))..add(GetMovieRecomendEvent(id)),
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MovieDetailesBloc,MovieDetailesState>(
      builder: (context, state) {
        switch (state.requestStateDetailes) {
                      ...
                      child: ShaderMask(
                        ...
                        child: CachedNetworkImage(
                          width: MediaQuery
                              ...
                              .size
                              .width,
                          imageUrl: ApiConstance.imageUrl(state.movieDetails!
                              .backdropPath),
                          fit: BoxFit.cover,
                        ),
                      ),
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Text(
                                    (state.movieDetails!.voteAaverage / 2)
                                        .toStringAsFixed(1),
                                    style: const TextStyle(
                                      fontSize: 16.0,
                                      fontWeight: FontWeight.w500,
                                  ...
                                  const SizedBox(width: 4.0),
                                  Text(
                                    '(${state.movieDetails!.voteAaverage})',
                                    style: const TextStyle(
                                      fontSize: 1.0,
                                      fontWeight: FontWeight.w500,
                                      letterSpacing: 1.2,
          ...
          case RequestState.isError:
            return Center(child: Text(state.movieDetailesMessage,));
        }
  ...
  builder: (context, state) {
    return SliverGrid(
      delegate: SliverChildBuilderDelegate(
        (context, index) {
          final recommendation = state.movieRecommendtion[index];
          return FadeInUp(
            from: 20,
            duration: const Duration(milliseconds: 500),
            child: ClipRRect(
